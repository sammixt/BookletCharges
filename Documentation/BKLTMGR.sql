DROP FUNCTION APPS.BKLT_MGR_VALIDATEADMINLOGIN1;

CREATE OR REPLACE FUNCTION APPS.bklt_mgr_validateadminlogin1 (
    v_staffid     VARCHAR2,
    v_username    VARCHAR2)
    RETURN VARCHAR2
IS
...
END;
/
DROP PROCEDURE APPS.BKLT_MGR_SELECT_ALL_USERS;

CREATE OR REPLACE PROCEDURE APPS.bklt_mgr_select_all_users(
   branch_code in varchar2, users_list out sys_refcursor)
   is
   begin
     open users_list for
       select APPS.BKLTMGR_USERS.STAFFNAME,APPS.BKLTMGR_USERS.STAFFID,APPS.BKLTMGR_USERS.EMAIL,APPS.BKLTMGR_USERS.BRANCHNAME
,APPS.BKLTMGR_USERS.BRANCHCODE,APPS.BKLTMGR_ROLES.ROLE_DESC,APPS.BKLTMGR_ROLES.ROLENAME FROM APPS.BKLTMGR_USERS
JOIN APPS.BKLTMGR_ROLES ON APPS.BKLTMGR_USERS.ROLEID = APPS.BKLTMGR_ROLES.ROLEID WHERE APPS.BKLTMGR_USERS.BRANCHCODE = branch_code;
end;
/
...
CREATE SEQUENCE APPS.BKLTMGR_ROLES_SEQ
  ...
  CACHE 20
  NOORDER;
DROP INDEX APPS.BKLTMGR_LOGINHISTORY_PK;
...
DROP INDEX APPS.BKLTMGR_LOG_DEBIT_PK;
...
DROP INDEX APPS.BKLTMGR_LSTISSDATE_PK;
...
DROP INDEX APPS.BKLTMGR_ROLES_PK;
...
NOPARALLEL;
DROP PACKAGE APPS.BKLTMGR;

CREATE OR REPLACE PACKAGE APPS.BKLTMGR AS
/******************************************************************************
   NAME:       BKLTMGR
   PURPOSE:
...
******************************************************************************/
  ...
  FUNCTION bklt_mgr_insert_request (
    ...
    branch_code varchar2)
    RETURN SYS_REFCURSOR;
    FUNCTION bklt_mgr_search_login (
    start_date VARCHAR2,
    end_date Varchar2)
    RETURN SYS_REFCURSOR;
    FUNCTION bklt_mgr_search_reqlog (
    start_date VARCHAR2,
    end_date Varchar2)
    RETURN SYS_REFCURSOR;
    FUNCTION bklt_mgr_search_reqlogid (
    login_id integer)
    RETURN SYS_REFCURSOR;
    FUNCTION bklt_mgr_search_credlog (
    start_date VARCHAR2,
    end_date Varchar2)
    RETURN SYS_REFCURSOR;
    FUNCTION bklt_mgr_search_credlogid (
    request_id integer)
    RETURN SYS_REFCURSOR;
    FUNCTION bklt_mgr_search_debitlog (
    start_date VARCHAR2,
    end_date Varchar2)
    RETURN SYS_REFCURSOR;
    FUNCTION bklt_mgr_search_debitlogid (
    request_id integer)
    RETURN SYS_REFCURSOR;
...
END BKLTMGR;
/
DROP PACKAGE BODY APPS.BKLTMGR;

CREATE OR REPLACE PACKAGE BODY APPS.BKLTMGR AS
/******************************************************************************
   NAME:       BKLTMGR
   PURPOSE:
...
BEGIN
    OPEN request_list FOR
        SELECT 
   APPS.BKLTMGR_LOGINHISTORY.LOGINID, APPS.BKLTMGR_LOGINHISTORY.STAFFID, APPS.BKLTMGR_LOGINHISTORY.LOGINDATE, 
   APPS.BKLTMGR_LOGINHISTORY.LOGINTIME,APPS.BKLTMGR_LOGINHISTORY.LOGOUTDATE,APPS.BKLTMGR_LOGINHISTORY.LOGOUTTIME
   
FROM APPS.BKLTMGR_LOGINHISTORY
WHERE APPS.BKLTMGR_LOGINHISTORY.LOGINDATE   BETWEEN TO_DATE(start_date,'MM/DD/YYYY') AND TO_DATE(end_date,'MM/DD/YYYY') ;
RETURN request_list;
END;
FUNCTION bklt_mgr_search_reqlog (
    start_date VARCHAR2,
...
BEGIN
    OPEN request_list FOR
        SELECT  apps.bkltmgr_request.requestid,apps.bkltmgr_request.accountname,apps.bkltmgr_request.accountnumber,apps.bkltmgr_request.serialnumberstart,apps.bkltmgr_request.serialnumberend,apps.bkltmgr_request.ssaid,apps.bkltmgr_request.hssaid,apps.bkltmgr_request.status,apps.bkltmgr_request.requestcreationdate,apps.bkltmgr_request.requestcreationtime,apps.bkltmgr_request.requestautorizationdate,apps.bkltmgr_request.requestautorizationtime,apps.bkltmgr_request.hssacomment from apps.bkltmgr_request where apps.bkltmgr_request.requestcreationdate BETWEEN TO_DATE(start_date,'MM/DD/YYYY') AND TO_DATE(end_date,'MM/DD/YYYY') ;
RETURN request_list;
...
BEGIN
OPEN request_list FOR
          SELECT  apps.bkltmgr_request.requestid,apps.bkltmgr_request.accountname,apps.bkltmgr_request.accountnumber,apps.bkltmgr_request.serialnumberstart,apps.bkltmgr_request.serialnumberend,apps.bkltmgr_request.ssaid,apps.bkltmgr_request.hssaloginid,apps.bkltmgr_request.hssaid,apps.bkltmgr_request.status,apps.bkltmgr_request.requestcreationdate,apps.bkltmgr_request.requestcreationtime,apps.bkltmgr_request.requestautorizationdate,apps.bkltmgr_request.requestautorizationtime,apps.bkltmgr_request.hssacomment from apps.bkltmgr_request where apps.bkltmgr_request.hssaloginid = login_id or apps.bkltmgr_request.ssaloginid = login_id;
 RETURN request_list;
...
BEGIN
    OPEN request_list FOR
        SELECT 
   APPS.BKLTMGR_LOG_CREDIT.REQUESTID, APPS.BKLTMGR_LOG_CREDIT.PAYMENTREF, 
   APPS.BKLTMGR_LOG_CREDIT.BATCHID, APPS.BKLTMGR_LOG_CREDIT.INITIATINGBRANCH, APPS.BKLTMGR_LOG_CREDIT.ACCOUNTNUMBER, 
   APPS.BKLTMGR_LOG_CREDIT.CREDIT, APPS.BKLTMGR_LOG_CREDIT.CURRENCY, APPS.BKLTMGR_LOG_CREDIT.NARRATION, 
   APPS.BKLTMGR_LOG_CREDIT.TRANSACTIONSTARTDATE, APPS.BKLTMGR_LOG_CREDIT.TRANSACTIONENDDATE, STATUS, 
   APPS.BKLTMGR_LOG_CREDIT.GLCASAINDICATOR, APPS.BKLTMGR_LOG_CREDIT.RESPONSECODE, APPS.BKLTMGR_LOG_CREDIT.RESPONSEMSG
FROM APPS.BKLTMGR_LOG_CREDIT WHERE TRUNC(APPS.BKLTMGR_LOG_CREDIT.TRANSACTIONSTARTDATE) BETWEEN TO_DATE(start_date,'MM/DD/YYYY') AND TO_DATE(end_date,'MM/DD/YYYY');
RETURN request_list;
...
BEGIN
   ...
   APPS.BKLTMGR_LOG_CREDIT.TRANSACTIONSTARTDATE, APPS.BKLTMGR_LOG_CREDIT.TRANSACTIONENDDATE, STATUS, 
   APPS.BKLTMGR_LOG_CREDIT.GLCASAINDICATOR, APPS.BKLTMGR_LOG_CREDIT.RESPONSECODE, APPS.BKLTMGR_LOG_CREDIT.RESPONSEMSG
    FROM APPS.BKLTMGR_LOG_CREDIT WHERE APPS.BKLTMGR_LOG_CREDIT.REQUESTID = request_id;
RETURN request_list;
...
BEGIN
    OPEN request_list FOR
        SELECT 
   APPS.BKLTMGR_LOG_DEBIT.REQUESTID, APPS.BKLTMGR_LOG_DEBIT.PAYMENTREF, 
   APPS.BKLTMGR_LOG_DEBIT.BATCHID, APPS.BKLTMGR_LOG_DEBIT.INITIATINGBRANCH, APPS.BKLTMGR_LOG_DEBIT.ACCOUNTNUMBER, 
   APPS.BKLTMGR_LOG_DEBIT.DEBIT, APPS.BKLTMGR_LOG_DEBIT.CURRENCY, APPS.BKLTMGR_LOG_DEBIT.NARRATION, 
   APPS.BKLTMGR_LOG_DEBIT.TRANSACTIONSTARTDATE, APPS.BKLTMGR_LOG_DEBIT.TRANSACTIONENDDATE, STATUS, 
   APPS.BKLTMGR_LOG_DEBIT.GLCASAINDICATOR, APPS.BKLTMGR_LOG_DEBIT.RESPONSECODE, APPS.BKLTMGR_LOG_DEBIT.RESPONSEMSG
FROM APPS.BKLTMGR_LOG_DEBIT WHERE TRUNC(APPS.BKLTMGR_LOG_DEBIT.TRANSACTIONSTARTDATE) BETWEEN TO_DATE(start_date,'MM/DD/YYYY') AND TO_DATE(end_date,'MM/DD/YYYY');
RETURN request_list;
...
BEGIN
   ...
   APPS.BKLTMGR_LOG_DEBIT.TRANSACTIONSTARTDATE, APPS.BKLTMGR_LOG_DEBIT.TRANSACTIONENDDATE, STATUS, 
   APPS.BKLTMGR_LOG_DEBIT.GLCASAINDICATOR, APPS.BKLTMGR_LOG_DEBIT.RESPONSECODE, APPS.BKLTMGR_LOG_DEBIT.RESPONSEMSG
    FROM APPS.BKLTMGR_LOG_DEBIT WHERE APPS.BKLTMGR_LOG_DEBIT.REQUESTID = request_id;
RETURN request_list;
...
/
ALTER TABLE APPS.BKLTMGR_LOGINHISTORY
  DROP CONSTRAINT BKLTMGR_LOGINHISTORY_PK;
...
ALTER TABLE APPS.BKLTMGR_LOG_DEBIT
  DROP CONSTRAINT BKLTMGR_LOG_DEBIT_PK;
...
ALTER TABLE APPS.BKLTMGR_LSTISSDATE
  DROP CONSTRAINT BKLTMGR_LSTISSDATE_PK;
...
ALTER TABLE APPS.BKLTMGR_ROLES
  DROP CONSTRAINT BKLTMGR_ROLES_PK;
...
ALTER TABLE APPS.BKLTMGR_ROLES ADD (
  ...
  (ROLEID)
  ENABLE VALIDATE);
DROP USER BKLT_MGR CASCADE;

CREATE USER BKLT_MGR
  IDENTIFIED BY <password>
  DEFAULT TABLESPACE USERS
  TEMPORARY TABLESPACE TEMP1
  PROFILE DEFAULT
  ACCOUNT UNLOCK;
  -- 1 System Privilege for BKLT_MGR 
  GRANT CREATE SESSION TO BKLT_MGR;
  -- 4 Object Privileges for BKLT_MGR 
    GRANT DELETE, INSERT, SELECT, UPDATE ON APPS.BKLTMGR_LOGINHISTORY TO BKLT_MGR;
    GRANT DELETE, INSERT, SELECT, UPDATE ON APPS.BKLTMGR_REQUEST TO BKLT_MGR;
    GRANT DELETE, INSERT, SELECT, UPDATE ON APPS.BKLTMGR_ROLES TO BKLT_MGR;
    GRANT DELETE, INSERT, SELECT, UPDATE ON APPS.BKLTMGR_USERS TO BKLT_MGR;
